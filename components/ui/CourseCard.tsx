  ...
  return (
    <>
      <article
        ...
        className="group cursor-pointer bg-[#fff7e8] border border-[#965e5d]/12 rounded-2xl overflow-hidden flex flex-col hover:shadow-[0_8px_32px_rgba(150,94,93,0.12)] hover:-translate-y-1 transition-all duration-300"
      >
        ...
        <div className="flex flex-col flex-1 p-5">
          ...
          <div className="flex flex-wrap gap-x-4 gap-y-1.5 mb-3">
            {curso.modalidad && (
              <span className="flex items-center gap-1.5 font-[family-name:var(--font-inter)] text-[11px] text-[#2a2522]/55 truncate">
                <MapPin size={12} weight="fill" className="text-[#965e5d] flex-none" />
                {curso.modalidad}
              </span>
            )}
            {curso.fecha && (
              <span className="flex items-center gap-1.5 font-[family-name:var(--font-inter)] text-[11px] text-[#2a2522]/55 truncate">
                <Calendar size={12} weight="fill" className="text-[#965e5d] flex-none" />
                {curso.fecha}
              </span>
            )}
            {curso.duracion && (
              <span className="flex items-center gap-1.5 font-[family-name:var(--font-inter)] text-[11px] text-[#2a2522]/55 truncate">
                <Clock size={12} weight="fill" className="text-[#965e5d] flex-none" />
                {curso.duracion}
              </span>
            )}
          </div>
          ...
          {curso.descripcion && (
            <p className="font-[family-name:var(--font-inter)] text-[#2a2522]/65 text-sm leading-relaxed mb-4 flex-1 line-clamp-2">
              {curso.descripcion}
            </p>
          )}
